...
/** 
        enum Enum1{
            VAL1 = 100,                                     // these kind of combination of number and string enum variables technically we can call heterogenious
            VAL2 = "VALUE_2"
        }
        console.log(Enum1);     //{ '100': 'VAL1', VAL1: 100, VAL2: 'VALUE_2' }
        console.log( Enum1[0])      // reverse map not possible
*/
/** 
        enum Enum1{
            VAL1 = 100,
            VAL2 = "VALUE_1",
            VAL_3                   //here we got an error bcz of Enum member must have initializer
        }
*/